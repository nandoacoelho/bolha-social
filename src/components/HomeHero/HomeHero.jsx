  ...
  <div className={styles.wrapper}>
    ...
    <div className={styles.heroText}>
      ...
      <p className={styles.body}>
        ...
        na rede e eles não são aparentes. Por isso essa iniciativa foi criada!
      </p>
      <p className={styles.body}>
        Quer descobrir qual é a sua bolha e como você usa a internet? Instale a extensão e tenha
